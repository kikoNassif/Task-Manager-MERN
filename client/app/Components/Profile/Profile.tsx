        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="text-gray-400">
            ...
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-3xl text-[#333]">10</span>
            </p>
          </div>
          <div className="text-gray-400">
            <p>In Progress:</p>
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-3xl text-[#333]">11</span>
            </p>
          </div>
          <div className="text-gray-400">
            <p>Tasks Open:</p>
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-3xl text-[#333]">25</span>
            </p>
          </div>
          <div className="text-gray-400">
            <p>Completed:</p>
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-3xl text-[#333]">20</span>
            </p>
          </div>
        </div>
      </div>
